...
file = "/mnt/win/meterology/test.csv"
...
# list the counts of observations for each station
#ratings_by_station = csvdata.groupby('STATION').size()
...
def sep_by_year(original_file):
    ...
    for year in years:
        file_name = os.path.join(data_dir, "%d_surface_data.csv"%year)
